...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\textwidth]{/home/rojiar/TEC/Anteproyecto/Anteproyecto/fig/ltxfig_prototipo}
...
\begin{figure}[htb]
  \centering
  \includegraphics{/home/rojiar/TEC/Anteproyecto/Anteproyecto/fig/prototipo_gnuplot}
...
ejemplo, ``En \cite{BELS} se propuso un nuevo algoritmo'', o ``En
\cite{ISEIISP1} los autores proponen tomar las ventajas de los
